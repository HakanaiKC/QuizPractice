              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">
                      <a href="AdminDashboardStatistics.jsp">Statistics</a>
                  </li>
                </ol>
              </div>
              <!-- /.col -->
                ...
                <div class="card">
                  ...
                  <div class="card-body table-responsive p-0">
                    <table class="table table-striped table-valign-middle">
                      ...
                      <tbody>
                        <tr>
                          <td style="max-width: 120px">Some Product</td>
                          <td>4.2</td>
                          <td>432</td>
                          <td>
                  ...
                  <div class="card-body">
                    ...
                    >
                      ...
                      <p class="d-flex flex-column text-right">
                        <span class="font-weight-bold"> 102 </span>
                    ...
                    >
                      ...
                      <p class="d-flex flex-column text-right">
                        <span class="font-weight-bold"> 18235 </span>
                    ...
                    >
                      ...
                      <p class="d-flex flex-column text-right">
                        <span class="font-weight-bold"> 1829 </span>

...
let createdQuesLength = document.getElementsByClassName("question").length;
let lastCreatedQues = document.getElementsByClassName("question")[createdQuesLength - 1].id;

let i = lastCreatedQues.substring(11, lastCreatedQues.length);
...
function addQue() {
    ...
    html += `<div class="col-sm-6 question" id="CreatedQuiz${i}">`;
...
//        console.log(" cau hoi : " + arr[n]);
    ...
    for (var n = 0; n < arr.length; n++) {
        ...
        console.log("cac dap an cau hoi : " + n);
